...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title> Recordia | Forgot password</title>
...
<div style="padding:0 2em 2em 2em">
    <p class="collection" style="padding:1em">
    ...
    <form method="POST" action="{{ route('login') }}">
      ...
      <div class="row pl-5 pr-5">
        <div class="input-field right">
          <button class="btn-large waves-effect waves-light"  onclick="ShowPreloader()">{{ __('Reset Link') }}</button>
        </div>
      </div>
    </form>
