...
$pageTitle = 'Event Configuration Page';
            ...
            <section class="tabs-vertical mt-1 section">
              <div class="row">
                <div class="col l4 s12">
                    @include('admin.configs.partials.navigation_event')
                </div>
                <div class="col l8 s12">
                  <!-- tabs content -->
                    @include('admin.configs.partials.instructions')           
                    @include('admin.configs.partials.activate_event')           
                    @include('admin.configs.partials.edit_event')           
                </div>
              </div>
            </section>
