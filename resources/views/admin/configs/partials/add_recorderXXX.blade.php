      ...
      <h6 class="card-title">Manage Recorders</h6>
           ...
           {{-- @if (count($existing_years))
              @foreach($existing_years as $year) --}}
                ...
                <a href="#modal1" class="chip mb-2 gradient-45deg-light-blue-indigo modal-trigger">
                      <span class="red-text" style="font-weight: 800">Peter Adetola</span>
                </a>

                <a href="#modal1" class="chip mb-2 gradient-45deg-light-blue-indigo modal-trigger">
                      <span class="red-text" style="font-weight: 800">Eugene Bassey</span>
                </a>
                ...
                style="border-top:1px solid #bdbdbd; border-right:1px solid #bdbdbd">
                      <span class="grey-text">Fiona Ilona</span>
                </a>
