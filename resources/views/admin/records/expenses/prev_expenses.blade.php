...
@php
$pageTitle = 'Expenses for the year '. getCurrentYear();
@endphp
 <!-- BEGIN: Page Main-->
    <div id="main">
      <div class="row">
          ...
          <div class="invoice-product-details">
            <table class="striped responsive-table" >
              ...
              @foreach($expenses as $expense)
                ...
                <tr class="{{ ($expense->transaction == 1 )? 'grey lighten-5' : '' }}">
                <td>
                  {{ $expense->name }}
                </td>
              ...
              <div class="col xl4 m7 s12 offset-xl3">
                <ul>
                  <li class="display-flex justify-content-between">
                    ...
                    <h6 class="invoice-subtotal-value">&#8358;{{formatAmount(sumOfAllExpenses())}}</h6>
                  </li>
                </ul>
              </div>
            </div>
